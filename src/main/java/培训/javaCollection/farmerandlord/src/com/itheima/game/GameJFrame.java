package 培训.javaCollection.farmerandlord.src.com.itheima.game;
...
import 培训.javaCollection.farmerandlord.src.com.itheima.domain.Poker;
...
public class GameJFrame extends JFrame implements ActionListener {
    ...
    public GameJFrame() {
        //设置任务栏的图标
        setIconImage(Toolkit.getDefaultToolkit().getImage("/Users/xianlong/Desktop/myOwnCode/src/main/java/培训/javaCollection/farmerandlord/image/poker/dizhu.png"));
        //设置界面
        initJframe();
        //添加组件
        initView();
